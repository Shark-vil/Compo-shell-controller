    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-header">Добавление сервера</div>
                ...
                <div class="card-body">
                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <input id="id-serverip" type="text" class="form-control" aria-describedby="emailHelp" placeholder="Введите ip сервера">
                        </div>
                        <div class="form-group">
                            <label>Port сервера</label>
                            <input id="id-serverPort" name="port" type="number" class="form-control" placeholder="Введите порт сервера">
                        </div>
                        <div class="form-group">
                            <label>Имя пользователя сервера</label>
                            <input id="id-serverUser" name="user" type="text" class="form-control" placeholder="Введите имя пользователя сервера">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div>
                                <input type="button" id="id-send-button" class="btn btn-primary" value="Добавить"/>
                            </div>
                        </div>
                    </form>
                </div>
