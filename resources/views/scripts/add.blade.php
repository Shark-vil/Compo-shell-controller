...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                {{ Breadcrumbs::render('server.scripts.add', $server_id) }}
                ...
                <div class="card-body">
                    ...
                    <form id="id-form-action">
                        <div class="form-group">
                            ...
                            <input id="id-commandDesc" type="text" class="form-control" required placeholder="Введите описание команды">
                        </div>
                        <div class="form-group">
                            <label>Команда</label>
                            <input id="id-command" name="port" type="text" class="form-control" required placeholder="Введите команду">
                        </div>
